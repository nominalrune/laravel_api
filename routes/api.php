...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/user/{user}', [UserController::class, 'update'])->can('update', User::class);
    ...
    Route::post('/tasks/{task}', [TaskController::class, 'update'])->can('update', Task::class);
    ...
    Route::post('/records/{record}', [RecordController::class, 'update'])->can('update', Record::class);
